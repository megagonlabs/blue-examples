...
ENV BLUE_DEPLOY_VERSION=${BLUE_DEPLOY_VERSION} ${BLUE_BUILD_PUBLISH} -t ${BLUE_DEV_DOCKER_ORG}/blue-agent-template_interactive${BLUE_BUILD_IMG_SUFFIX}:v${BLUE_DEPLOY_VERSION} -f Dockerfile.agent .
