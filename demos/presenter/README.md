...
See [Form Designer Tool](https://github.com/rit-git/blue/blob/dev/QUICK-START.md#form-designer) to learn more about how to design UIs.
...
The `PRESENTER` agent is defined [here](https://github.com/rit-git/blue/blob/dev/lib/blue/agents/presenter.py))
...
To try out the agent, first follow the [quickstart guide](https://github.com/rit-git/blue/blob/dev/QUICK-START.md) to deploy the `Presenter Agent` (`PRESENTER`).
