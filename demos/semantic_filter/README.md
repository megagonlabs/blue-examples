...
The `OPENAI___SEMANTIC_FILTER` agent is a derivative agent of the `OPENAI` agent. You can find the code of `OPENAI` agent [here](https://github.com/rit-git/blue/blob/dev/lib/blue/agents/openai.py)
