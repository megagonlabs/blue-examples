...
Additionally, to try out this demo, follow the [quickstart guide](https://github.com/rit-git/blue/blob/dev/QUICK-START.md) to deploy `NL-to-SQL Agent` (`NL2SQL`) agent and add the `NL-to-SQL Agent - Interactive` (`NL2SQL___INTERACTIVE`) agent to a session.
